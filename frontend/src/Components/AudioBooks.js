...
function AudioBooks() {
  ...
  const addAudioBookItemTofavouritelist = (i, image, name, url) => {
  ...
  /* Creating an asynchronous function to perform the API call using axios. I am requesting the data
     ...
     if not, an alert will come up asking the user to enter an artists name before trying to search for Audio books.  */
  ...
  const displayAudioBookInformation = () => {
    if (searchResults) {
      return (
        <>
              ...
              return (
                <div className="individualElementContainer">
                  ...
                  <button
                    ...
                    onClick={() =>
                      addAudioBookItemTofavouritelist(
                        i,
                        res.artworkUrl100,
                        res.artistName,
                        res.previewUrl
  ...
  return (
    <div className="mainAudiBookContainer">
      ...
      {/* Creating a div to contain the results from the 'displayAudioBookInformation' function. */}
      <div id="outerMusicInfoContainer">{displayAudioBookInformation()}</div>
